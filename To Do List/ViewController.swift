...
//    var toDoNotesArray = ["I should be certain to do all of the exercises at the end of the chapter before the exam.", "Take my idea's to the school's venture competition and win the big check.", "Focus apps on empowerment for all, with an extra bonus for users who are kind."]
